...
const ManageBooking = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      <Title title="Manage Bookings" subTitle="Track all the customer bookings, approve or cancle requests, and manage booking statuses."/>
          ...
          <tbody>
            {bookings.map((booking, index)=>(
              <tr key={index} className='border-t border-borderColor text-gray-500'>
                ...
                <td className='p-3 max-md:hidden'>{currency}{booking.price}</td>
