...
const Testimonial = () => {
  return (
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 mt-20 mb-25">
            <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden">
                <div className="flex items-center gap-4 px-5 py-4 bg-red-500/10">
                    ...
                    <div>
                        ...
                        <p className="text-gray-800/80">Barcelona, Spain</p>
                    </div>
                </div>
                <div className="p-5 pb-7">
                    ...
                    <p className="text-gray-500 mt-5">"I've rented a car from CarRental and it was an amazing experience!"</p>
                </div>
            ...
            <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden">
                <div className="flex items-center gap-4 px-5 py-4 bg-red-500/10">
                    ...
                    <div>
                        ...
                        <p className="text-gray-800/80">New York, USA</p>
                    </div>
                </div>
                <div className="p-5 pb-7">
                    <div className="flex gap-0.5">
                    ...
                    <p className="text-gray-500 mt-5">"CarRental made my trip much easier.The car was in perfect condition and the service was outstanding."</p>
                </div>
                <a href="#" className="text-red-500 underline px-5">Read more</a>
            </div>
            ...
            <div className="text-sm w-80 border border-gray-200 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden">
                <div className="flex items-center gap-4 px-5 py-4 bg-red-500/10">
                    ...
                    <div>
                        <h1 className="text-lg font-medium text-gray-800">Anny Washington</h1>
                        <p className="text-gray-800/80">Sydney, Australia</p>
                    </div>
                </div>
                <div className="p-5 pb-7">
                    <div className="flex gap-0.5">
                    ...
                    <p className="text-gray-500 mt-5">"I highly recommend CarRental for anyone looking for a reliable and comfortable car rental experience."</p>
                </div>
                <a href="#" className="text-red-500 underline px-5">Read more</a>
            </div>
        </div>
